...
export const addNewBlog = createAsyncThunk(
  ...
  async (blogData) => {
    try {
      ...
      const response = await axiosInstance.post('https://laughing-halibut-x5wqwwjg6jqq249j-5220.app.github.dev/api/Blogs/AddBlog', blogData);
...
export const deleteBlog = createAsyncThunk(
  ...
  async (blogid) => {
      try {
          ...
          const response = await axiosInstance.delete('https://laughing-halibut-x5wqwwjg6jqq249j-5220.app.github.dev/api/Blogs/DeleteBlog',
              { data: { blogId: blogid} }
          );
          return response.data;
      } catch (error) {
...
export const getBlog = createAsyncThunk(
  ...
  async (blogid) => {
    try {
      ...
      const response = await axiosInstance.post('https://laughing-halibut-x5wqwwjg6jqq249j-5220.app.github.dev/api/Blogs/ReturnOneBlog', blogid);
      return response.data;
    } catch (error) {
      throw error;
    }
...
export const addLike = createAsyncThunk(
  ...
  async (blogid) => {
    try {
      ...
      const response = await axiosInstance.post('https://laughing-halibut-x5wqwwjg6jqq249j-5220.app.github.dev/api/Blogs/Like', blogid);
      return response.data;
    } catch (error) {
      throw error;
    }
...
export const addDislike = createAsyncThunk(
  ...
  async (blogid) => {
    try {
      ...
      const response = await axiosInstance.post('https://laughing-halibut-x5wqwwjg6jqq249j-5220.app.github.dev/api/Blogs/DisLike', blogid);
      return response.data;
    } catch (error) {
      throw error;
    }
