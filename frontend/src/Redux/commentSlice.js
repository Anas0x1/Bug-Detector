...
export const addNewComment = createAsyncThunk(
    ...
    async (commentData) => {
        try {
            ...
            const response = await axiosInstance.post('http://localhost:5220/api/Comment/AddComment', commentData);
...
export const addCommentLike = createAsyncThunk(
    ...
    async (commentid) => {
        try {
            ...
            const response = await axiosInstance.post('http://localhost:5220/api/Comment/Like', commentid);
            return response.data;
        } catch (error) {
            throw error;
        }
...
export const deleteComment = createAsyncThunk(
    ...
    async (commentData) => {
        try {
            ...
            const response = await axiosInstance.delete('http://localhost:5220/api/Comment/DeleteComment',
...
export const addCommentDislike = createAsyncThunk(
    ...
    async (commentid) => {
        try {
            ...
            const response = await axiosInstance.post('http://localhost:5220/api/Comment/DisLike', commentid);
            return response.data;
        } catch (error) {
            throw error;
        }
...
export const fetchAllComment = createAsyncThunk(
    ...
    async (blogId) => {
        try {
            ...
            const response = await axiosInstance.post('http://localhost:5220/api/Comment/ReturnCommentsForBlog', blogId);
            return response.data;
        } catch (error) {
            throw error;
        }
